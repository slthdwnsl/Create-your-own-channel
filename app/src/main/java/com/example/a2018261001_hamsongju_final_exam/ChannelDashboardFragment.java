...
import com.example.a2018261001_hamsongju_final_exam.Adapter.ViewPagerAdapter;
...
public class ChannelDashboardFragment extends Fragment {
    ...
    private void initAdapter() {
        ...
        adapter.add(new HomeDashboard(),"홈");
        adapter.add(new VideosDashboard(), "동영상");
        adapter.add(new PlaylistDashboard(), "재생목록");
        adapter.add(new CommunityDashboard(), "커뮤니티");
        adapter.add(new SettingsDashboard(), "설정");
